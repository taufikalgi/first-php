        				...
        				<div class="row">
        					<div class="column">
         					<div class="col-sm-6 col-lg-10">
          						<a class="dropdown-item" href="menu_kendaraan.php"><h5>Kendaraan</h5></a>
        					...
        					<div class="column">
         					<div class="col-sm-6 col-lg-10">
          						<a class="dropdown-item" href="menu_elektronik.php"><h5>Elektronik</h5></a>
        					...
        					<div class="colomn">
         					<div class="col-sm-6 col-lg-10">
          						<a class="dropdown-item" href="menu_perlengkapan.php"><h5>Rumah Tangga</h5></a>
